\begin{tikzpicture}
  ...
  \matrix[matrix of nodes, row sep=1.5em, column sep=1.5em, right=5em of t2.east, yshift=0.5em, matrix anchor=a3.base west] (t3) {
    |[nop,eq1] (a3)| \underline{a}  &
    |[p1]  (b3)| b  &
    |[nop,eq2] (c3)| c  \\
  };

  \matrix[matrix of nodes, row sep=1.5em, column sep=1.5em, at={($(a1.base east -| c3.west)+(6em,0)$)}, matrix anchor=a4.base west] (t4) {

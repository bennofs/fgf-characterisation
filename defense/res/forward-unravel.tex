\begin{tikzpicture}
  ...
  \begin{scope}[every node/.style={uncover=<2->}, every path/.style={uncover=<2->}]
    \matrix[matrix of nodes, every node/.style={el},name=n,column sep=2em, row sep=2em, ampersand replacement=§, matrix anchor=1.base, below=7em of defif.south west, uncover=<2->]  {
      |(1)| a \\ |(2)| b \\ |(3)| c \\
    };
  ...
  \begin{scope}[tolbrightRed, uncover=<3->]

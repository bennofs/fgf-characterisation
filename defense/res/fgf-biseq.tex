\begin{tikzpicture}
  ...
  \tikzset{seq2/.style={uncover=<2->}}
  \tikzset{seq3/.style={uncover=<3->}}
  \tikzset{seq4/.style={uncover=<6->}}
  ...
  \begin{scope}[Biseq, xshift=5em]
    ...
    below=2ex of tuples.south west,
    inner xsep=0pt,
    font=\Large,
    uncover=<-6>,
    ] {
      |[font=\bfseries\Large] (headbiseq)| bisimulation sequences (biseqs) \\
      |[seq1]| $\tups$ \\
      |[seq2]| $\tups(2,3)\tupt$ \\
      |[seq3]| $\tups(2,2)\tupt$ \\
      |[seq4]| $\tups(2,3)\tupt(3,3)\tupu$ \\
    };

    \begin{scope}[uncover=<7->]
      \node[font=\bfseries\Large, anchor=base west, inner xsep=0pt] (headbipoint) at (headbiseq.base west) { bisimulation points (bipoints) };
      \matrix[
      matrix of nodes,
      row sep=2ex,
      column sep=1.5em,

\begin{tikzpicture}
  ...
  \begin{scope}[font=\small]
    \node[anchor=base east,text width=5em] at ($(t1)!.45!(l1) - (0.5em,0)$) { $\mathsf{seq}$ level $\le D$ };
    \node[anchor=base east,text width=5em] at ($(t1)!1.2!(l1) - (0.5em,0)$) { $\mathsf{seq}$ level $= D + 1$ };
  \end{scope}
  ...
  \begin{scope}[uncover=<5->, font=\Huge]
    \coordinate (mid) at ($(cop2)!.5!(cop3)$);
    \node at (mid |- 0em,-13em)  { $\unravel{A}_{\ell}$ };
  \end{scope}
\end{tikzpicture}

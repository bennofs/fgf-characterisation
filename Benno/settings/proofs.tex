...
\declaretheoremstyle[
  ...
  spaceabove=0pt,
  spacebelow=0pt,
  mdframed={style=mdblackbox,needspace=6em}
]{thmblackbox}
...
\declaretheorem[name=Example,sibling=definition,style=thmblackbox,numbered=no]{examplex*}
...
{\popQED\endexamplex}
\newenvironment{example*}
{\pushQED{\qed}\renewcommand{\qedsymbol}{$\square$}\csname examplex*\endcsname}
{\popQED\endexamplex}

...
\begin{lemma}[no short directed cycles]
...
\begin{proof}
  ...
  All consecutive elements $p_{r}, p_{r+1}, \ldots, p_{n}$ are linked by $\mathit{Next}$.
  So the length of $\seq{}$ can only increase by at most one for consecutive elements.
  It follows that $n - r >= \theta$ and $|p| >= \theta$.
\end{proof}

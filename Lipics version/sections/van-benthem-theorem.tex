...
\end{theorem}
The proof of this theorem is developed across \cref{sec:unraveling,sec:finite}.
...
\end{lrbox}
\begin{proofsketch}
  By employing previous developments of Otto~\cite[Obs.~13]{Otto04}, it suffices to show that for every first-order formula that is $\bisimto_{\FGF}$-invariant (in the finite) is also $\bisimto_{\FGF}^{\ell}$-invariant (in the finite) for some $\ell \in \N$.

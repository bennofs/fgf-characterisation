...
A classical result of van Benthem states that the classical modal logic $\mathrm{K}$ is the bisimulation-invariant fragment of first-order logic~\cite[Thm.~2.2.1]{AndrekaNB98}. The constructive version of the theorem (that also works in the finite) was provided later by Rosen~\cite[
Prop.~4]{Rosen97}.
A constructive analogous of van Benthem's theorem was shown for the guarded fragment by Otto~\cite{Otto2012}.
\begin{theorem}\label{thm:vanBenthem-for-GF}
\bbebox{Benno, you must do some painful work here and say precisely what we get for the $\GF$.}
\end{theorem}

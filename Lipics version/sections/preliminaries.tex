...
\bfside{is coordinates a standard term to refer to the members of a tuple? it wasn't clear to me whether this means the set of indices or the set of components of a tuple}

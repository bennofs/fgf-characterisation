...
If we allow backward transitions, we need to also consider the case that a move is removed from the end of a sequence.
...
\end{definition}
This definition is analogous to a construction used by Otto in the upgrading from global bisimulation for modal logic to two-way global bisismulation for modal logic~\cite[Def. 39]{Otto04}.

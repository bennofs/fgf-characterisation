...
Let $g$ be descendant of $e$ with distance $d$ from $e$ and $\seq{g} = \seq{e}\cdots(i,j)\elemtuple{v}$.
Then there is descendant $h$ of $f$ with $\seq{h} = \seq{f}\cdots(i,j)\elemtuple{w}$ and $\str{A}, \elemtuplev \bisimto_{\FGF}^{z-d} \str{B}, \elemtuplew$.

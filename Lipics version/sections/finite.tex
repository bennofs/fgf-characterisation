...
\begin{proofsketch}
  ...
  \begin{romanenumerate}
    ...
    We can find such an element by employing~\ref{bisim:forth} $W * k$ times.\bfside{make more precise using $(W * k)$-ends}

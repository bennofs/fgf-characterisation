...
It is easy to see that the possible moves of Spoiler are equivalent to the back-and-forth conditions for $\FGF$-bisimulation. \bbe{reference}
...
The bisimulation sequence $\tupp(2,2)\tupe$ represents the move from $\tupp$ to $\tupe$, while keeping the second element of $\tupp$.
...
The bisimulation sequence $\tupp(1,1)\tupp$ is an extension of $\tupp$.

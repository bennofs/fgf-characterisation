\begin{tikzpicture}
  ...
  \begin{scope}[xshift=10em, yshift=2.5em]
  ...
  \node[element] (p1) {$(\elemtuplep, 1)$}
    ...
    \begin{scope}[fill opacity=0.5, text opacity=1]
      ...
      \fill[tolbrightGreen] ($(p1.center) + (1em, 1em)$) circle[radius=0.7em] coordinate (p1c1);
      \fill[tolbrightGreen] ($(p1.center) + (-1em, 1em)$) circle[radius=0.7em] coordinate (p1c2);
      \fill[tolbrightGreen] ($(p1.center) + (-1em, -1em)$) circle[radius=0.7em] coordinate (p1c3);
      \fill[tolbrightGreen] ($(p1.center) + (1em, -1em)$) circle[radius=0.7em] coordinate (p1c4);

      \fill[tolbrightGreen] ($(p2.center) + (-1em,0.5em)$) circle[radius=0.7em] coordinate (p2c1);
      \fill[tolbrightGreen] ($(p2.center) + (1.3em,0.3em)$) circle[radius=0.7em] coordinate (p2c2);
      \fill[tolbrightYellow] ($(p2.center) + (0.5em,-1em)$) circle[radius=0.4em] coordinate (p2c3);
      \fill[tolbrightYellow] ($(p2.center) + (-0.4em,-0.8em)$) circle[radius=0.4em] coordinate (p2c4);
      \fill[tolbrightYellow] ($(p2.west) + (0.1em,-0.4em)$) circle[radius=0.4em] coordinate (p2c5);

      \fill[tolbrightGreen] ($(p3.center) + (1.3em, 0)$) circle[radius=0.7em] coordinate (p3c1);
      \fill[tolbrightYellow] ($(p3.center) + (0.6em, 0.8em)$) circle[radius=0.4em] coordinate (p3c2);

      \fill[tolbrightYellow] ($(p22e2.center) + (2em, 0.8em)$) circle[radius=0.4em] coordinate (p22e2c1);

      \fill[tolbrightGreen] ($(p12p3.north) + (1em, 0em)$) circle[radius=0.7em] coordinate (p12p3c1);
      \fill[tolbrightYellow] ($(p12p3.east) + (0em, -0.5em)$) circle[radius=0.4em] coordinate (p12p3c2);

      \fill[tolbrightGreen] ($(p11p2.north) + (0,0)$) circle[radius=0.7em] coordinate (p11p2c1);
      \fill[tolbrightGreen] ($(p11p2.south west) + (0,0)$) circle[radius=0.7em] coordinate (p11p2c2);
      \fill[tolbrightYellow] ($(p11p2.east) + (0,0)$) circle[radius=0.4em] coordinate (p11p2c3);
      \fill[tolbrightYellow] ($(p11p2.center) + (1em,-0.9em)$) circle[radius=0.4em] coordinate (p11p2c4);
      \fill[tolbrightYellow] ($(p11p2.south) + (-0.9em,-0.1em)$) circle[radius=0.4em] coordinate (p11p2c5);

      \fill[tolbrightGreen] ($(p11p3.north) + (0,0)$) circle[radius=0.7em] coordinate (p11p3c1);
      \fill[tolbrightYellow] ($(p11p3.north west) + (0.2em,-0.2em)$) circle[radius=0.4em] coordinate (p11p3c2);

      \fill[tolbrightGreen] ($(p11p12p3.north) + (-2em,0)$) circle[radius=0.7em] coordinate (p11p12p3c1);
      \fill[tolbrightYellow] ($(p11p12p3.north) + (-0.5em,0)$) circle[radius=0.4em] coordinate (p11p12p3c2);

      \fill[tolbrightYellow] ($(p11p22e2.north) + (-3.5em,0)$) circle[radius=0.4em] coordinate (p11p22e2c1);
      ...
      \begin{scope}[tolbrightGreen, line width=0.4em, relation/.style={
        ...
        \draw[relation] (p1c3) to[out=-130, in=30] node[below=0.5em]{P} (p2c2) to[out=-60, in=60] (p3c1);
      ...
      \begin{scope}[tolbrightYellow, line width=0.25em, relation/.style={
        ...
        \draw[relation] (p2c4) to[out=-135,in=45] node[below right=-0.2em]{E} (p22e2c1);
        \draw[relation] (p2c5) to node[below left=0.2em]{E} (p12p3c2);
